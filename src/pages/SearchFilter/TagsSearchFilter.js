...
const TagsSearchFilter = ({value,dataToSend,handleLinkClick,resetCounter}) => {
...
function filterData(data, searchFilterValue) {
  if (searchFilterValue !== "") {
    return data.filter((item) => {
      ...
      const jobNumberValue = item["tags"] || ''; // Handle cases where the property is null or undefined
