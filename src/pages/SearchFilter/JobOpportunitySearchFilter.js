...
const JobOpportunitySearchFilter = ({value,dataToSend,handleLinkClick,resetCounter}) => {
...
function filterData(data, searchFilterValue) {
  if (searchFilterValue !== "") {
    return data.filter((item) => {
      ...
      const jobNumberValue = item["job_number"] || ''; // Handle cases where the property is null or undefined
...
export default JobOpportunitySearchFilter